...
public class ClientSecurityModule : NSObject {
    ...
    @objc public init(snippetId: String, token: String, domain: String? = nil, location: String? = nil,
        ...
        RSdkHTTPProtocol.postDeviceData(_snippetId: snippetId, _token: token, _location: location, _enableLoactionFinder: enableLocationFinder, _geoLocation: geoLocation) {
