...
public struct Sysctl {
    ...
    public static var machineArch: String { return try! Sysctl.stringForKeys([CTL_HW, HW_MACHINE_ARCH]) }
    ...
    public static var kernID: Int32 { return try! Sysctl.valueOfType(Int32.self, forKeys: [CTL_KERN, KERN_SAVED_IDS]) }
    ...
    public static var domainName: String { return try! Sysctl.stringForKeys([CTL_KERN, KERN_DOMAINNAME]) }
