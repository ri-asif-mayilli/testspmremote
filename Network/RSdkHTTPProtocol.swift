...
internal class RSdkHTTPProtocol {
    ...
    internal class func postDeviceData(_snippetId : String, _token: String, _location: String? = nil, _enableLoactionFinder: Bool = false, _geoLocation: CLLocation? = nil, _completion: @escaping (Error?) -> Void) {
        
        DeviceDTOFactory.createDTO(_snippetId: _snippetId, _requestToken: _token, _location: _location, _geoLocation: _geoLocation, _completion: { (device) in
